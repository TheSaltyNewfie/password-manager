...
New_Pass = Text(
    sign_up_window, text="Master Password: ", grid=[0, 1], size=20, align="left"
)
New_PassBox = TextBox(
...
Confirm_Pass = Text(
    sign_up_window, text="Confirm Password: ", grid=[0, 3], size=20, align="left"
)
...
Back = PushButton(
    sign_up_window, text="Back", align="bottom", grid=[2, 0], command=closed_window
)
Confirm = PushButton(
